...
public class WindowUtils {
     ...
     * 显示弹出框
     */
    public static void showPopupWindow(final Context context,int layout) {
        if (isShown) {
        ...
        mView = setUpView(context,layout);
    ...
    private static View setUpView(final Context context,int layout) {
